...
#undef BCM2835_MODULE_BUILD

// repeatedly address conversion functions
#define SHIFT4(a) (a >> 2u)
#define SHIFT32(a,b) ((a >> 2u) + (b >> 5u))
#define SHIFT16(a,b) ((a >> 2u) + (b >> 4u))
#define SHIFT10(a,b) ((a >> 2u) + (b/10u))
...
/*! Offset interrupt registers */ 
#define BCM2835_IRQ_BASE				0xb000
...
#define BCM2835_IRQ_ENB1						0x0210	/* enable irq31..0 */
#define BCM2835_IRQ_ENB2						0x0214	/* enable irq63..32 */
#define BCM2835_IRQ_DIS1						0x021C	/* disable irq31..0 */
#define BCM2835_IRQ_DIS2						0x0220	/* distable irq63..32 */

#define GPIO_IRQ1_BASE							 0		/* first irq for register 1  */
#define GPIO_IRQ2_BASE							32		/* first irq for register 2  */
#define GPIO_IRQ0								49		/* 49 - 32 = 17 bit in reg2 */
#define GPIO_IRQ1								50		/* 50 - 32 = 18 bit in reg2 */
#define GPIO_IRQ2								51		/* 51 - 32 = 19 bit in reg2 */
#define GPIO_IRQ3								52		/* 52 - 32 = 20 bit in reg2 */
...
extern "C" {
    ...
    */
	...
	extern void bcm2835_gpio_ren_multi(uint32_t value);
	extern void bcm2835_gpio_ren_multi_set(uint32_t value);
    extern uint32_t bcm2835_gpio_ren_multi_get(void);
    ...
    */
	...
	extern void bcm2835_gpio_fen_multi(uint32_t value);
    extern void bcm2835_gpio_fen_multi_set(uint32_t value);
    extern uint32_t bcm2835_gpio_fen_multi_get(void);
    ...
    */
    ...
    /* testing function just output */
    extern void bcm2835_spi_transfer_nowait(uint8_t value);
    ...
    */
	...
	extern uint64_t bcm2835_st_read_nb(void);
    ...
    */
    ...
    /*!Disable given irq number 0..63
     */
    extern void bcm2835_irq_disable(uint32_t irq);
    
#define CAPTURE_VALUES 1024
...
typedef struct {
	...
	extern void start_capture(void);

	extern void set_capture_mask(uint32_t mask);
	
	extern void set_pre_trigger(uint32_t mask);

	extern void start_timer(void);
	
	extern void stop_timer(void);
	
	extern uint32_t capture_ready(tCapture *data);

	extern uint32_t capture_size(void);

	extern int capture(void *arg);
    /*! @}  */
#ifdef __cplusplus
}
#endif
